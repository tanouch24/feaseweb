...
const tables = ["prospects", "clients", "sites", "subscriptions", "payments", "modification_requests", "client_updates", "seo_actions", "seo_metrics", "domains", "internal_notes", "activity_log"] as const;
